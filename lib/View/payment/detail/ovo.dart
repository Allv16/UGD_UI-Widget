...
class ovoView extends StatefulWidget {
  const ovoView({Key? key}) : super(key: key);

  @override
  _ovoViewState createState() => _ovoViewState();
}

class _ovoViewState extends State<ovoView> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              'images/ovo.png', // Change the path as needed
              height: 150.0,
            ),
            Center(
              child: Text(
