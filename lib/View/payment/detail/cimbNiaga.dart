...
class cimbNiagaView extends StatefulWidget {
  const cimbNiagaView({Key? key}) : super(key: key);

  @override
  _cimbNiagaViewState createState() => _cimbNiagaViewState();
}

class _cimbNiagaViewState extends State<cimbNiagaView> {
