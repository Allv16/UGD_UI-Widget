...
class shopeeView extends StatefulWidget {
  const shopeeView({Key? key}) : super(key: key);

  @override
  _shopeeViewState createState() => _shopeeViewState();
}

class _shopeeViewState extends State<shopeeView> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              'images/shopee.png', // Change the path as needed
              height: 150.0,
            ),
            Center(
              child: Text(
