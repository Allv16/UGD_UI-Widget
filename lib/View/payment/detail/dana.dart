...
class danaView extends StatefulWidget {
  const danaView({Key? key}) : super(key: key);

  @override
  _danaViewState createState() => _danaViewState();
}

class _danaViewState extends State<danaView> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              'images/dana.png', // Change the path as needed
              height: 150.0,
            ),
            SizedBox(height: 0),
            Center(
