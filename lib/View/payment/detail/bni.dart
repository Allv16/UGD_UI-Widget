...
class bniView extends StatefulWidget {
  const bniView({Key? key}) : super(key: key);

  @override
  _bniViewState createState() => _bniViewState();
}

class _bniViewState extends State<bniView> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Image.asset(
              'images/bni.png', // Change the path as needed
              height: 80.0,
            ),
            SizedBox(height: 15),
            Center(
