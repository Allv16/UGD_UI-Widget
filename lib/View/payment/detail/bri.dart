...
class briView extends StatefulWidget {
  const briView({Key? key}) : super(key: key);

  @override
  _briViewState createState() => _briViewState();
}

class _briViewState extends State<briView> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Image.asset(
              'images/bri.png', // Change the path as needed
              height: 80.0,
            ),
            SizedBox(height: 15),
            Center(
