                  ...
                  if(idReservation == -1){
                    if(isSwitched){
                          ...
                          Navigator.pushAndRemoveUntil(
                            context,
                            MaterialPageRoute(builder: (context) =>  bookingSuccessBPJSPage(has_bpjs: isSwitched,doctor_name: widget.doctor_name!,reservation_date: selectedDate!, jam_praktek: selectedTime!)),
                            (route) => false,
                          );
                        }else{
                          ...
                          Navigator.pushAndRemoveUntil(
                            context,
                            MaterialPageRoute(builder: (context) => bookingSuccessPage(has_bpjs: isSwitched,doctor_name: widget.doctor_name!,reservation_date: selectedDate!, jam_praktek: selectedTime!, id_payment: idPayment!,)),
                            (route) => false,
                          );
                        }
                  }else{
