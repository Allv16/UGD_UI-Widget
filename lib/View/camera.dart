...
import 'package:ugd_ui_widget/View/display_picture.dart';
...
class _CameraViewState extends State<CameraView> {
  ...
  Future<void> initializeCamera() async {
    LoggingUtils.LogStartFunction("initalize camera".toUpperCase());
    ...
    if (mounted) {
      setState(() {});
      LoggingUtils.LogEndFunction("success initalize camera".toUpperCase());
    }
  }
