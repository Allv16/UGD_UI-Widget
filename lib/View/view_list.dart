...
import 'package:ugd_ui_widget/data/people.dart';
    ...
    return Row(
      children: [
        ...
        Expanded(
          flex: 3,
          child:
              _person == null ? const Placeholder() : PersonalDetail(_person!),
        )
      ],
    );
  }
...
class PersonalDetail extends StatelessWidget {
  final Person person;
  const PersonalDetail(this.person, {super.key});
