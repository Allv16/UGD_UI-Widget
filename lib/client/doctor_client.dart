...
class doctorClient {
  ...
  static final String endpoint = '/api/doctors';

  static Future<List<Dokter>> fetchDokterBySpecialization(
      String specialization) async {
    try {
      var response = await get(Uri.http(url, "$endpoint/$specialization"));
